...
So the expected out of sample accuracy is `r meanAccuracy`% $\pm$ `r error` (95% confidence interval). The expected out of sample error is: 1 - accuracy = `r 100 - meanAccuracy`%. Finally, we train a model on the full data and apply to the test set (with predicors removed as in the train set). Finally, the answers are written as described in the instructions. 
